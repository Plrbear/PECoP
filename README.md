...
# Download
To download the FineDiving dataset, please sign the Release Agreement and send it to a.dadashzadeh@bristol.ac.uk. By sending the application, you are agreeing and acknowledging that you have read and understand the notice. We will reply with a link and the corresponding guidelines right after we receive your request.
